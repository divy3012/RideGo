    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900 overflow-x-hidden">
      <div className="absolute top-5 left-5 z-50">
        <motion.button
          whileTap={{ scale: 0.88 }}
          onClick={() => router.back()}
          className="w-11 h-11 rounded-full bg-white border border-zinc-200 shadow-sm flex  items-center justify-center hover:bg-zinc-50 transition-colors "
        >
      ...
      >
        <div className="px-5 lg:px-8 max-w-6xl mx-auto">
          <motion.div
            ...
            className="bg-zinc-50 border border-zinc-200 rounded-2xl mb-5 overflow-hidden"
          >
            <div className="flex gap-3 px-4 py-3 border-b border-zinc-100">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] tracking-widest font-semibold text-zinc-400 uppercase mb-0.5">
                  PickUp
                </p>
                <p className="text-sm font-semibold truncate text-zinc-900 leading-snug">
                  {pickUp || "-"}
                </p>
              </div>
          ...
          >
            <div>
              <h2 className="text-zinc-900 tracking-tight text-lg font-black">
                {loading
                  ? "Finding Vehicles..."
                  : vehicles.length > 0
                    ? "Available"
      ...
      <AnimatePresence>
        {!loading && vehicles.length == 0 && (
          ...
          >
            ...
            <p className=" text-zinc-900 text-base font-bold mb-1">
              Vehicles Not Found
            </p>
            <p className=" text-zinc-400 text-sm max-w-xs leading-relaxed">
              {meta.label || "Vehicle"} drivers are available near your pickup
              right now.
            </p>
            <motion.button
              whileTap={{ scale: 0.95 }}
              ...
              <VehicleCard
                ...
                onBook={() => {
                  const url = new URLSearchParams({
                    ...
                    fare: String(Math.round(v.baseFare! + v.priceParKM! * km)),
