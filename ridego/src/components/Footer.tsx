    ...
    <div className="w-full bg-black text-white">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <h2 className="text-2xl font-bold tracking-wide">RideGo</h2>
            <p className="mt-4 text-gray-400 text-xs leading-relaxed ">
              Book any vehicle - bike to truck. Trusted owners. Transparent
              pricing.
            </p>
        ...
        <div className=" border-t border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 gap-4">
