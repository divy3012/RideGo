...
const VEHICLE_CATEGORIES = [
  ...
  {
    title: "Car",
    desc: "Comfertable city travel",
    Icon: Car,
    tag: "Comfertable",
  },
  { title: "SUVs", desc: "Premium and spacious", Icon: Car, tag: "Premium" },
  {
    title: "Vans",
    ...
    <div className="w-full bg-white py-20 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      className=" inline-flex items-center gap-1.5 border text-[9px] font-black uppercase tracking-[0.18em] px-2.5 py-1. rounded-full mb-5 transition-colors5"
                    >
                      <Sparkles size={8} />
                      {c.tag}
                    </motion.div>
        ...
        <motion.div
          ...
          className=" flex items-center justify-center gap-6 mt-8 pt-6 border-t border-zinc-100"
        >
          {[
            { num: "6+", label: "Categories" },
            { num: "10+", label: "Vehicle types" },
            { num: "24/7", label: "Availibility" },
          ].map((d, i) => (
