    ...
    >
      ...
      <div className="relative z-10">
        <motion.div
          ...
          className={`w-11 h-11 row-gap-xl flex items-center justify-center ${cfg.iconBg} ${cfg.iconColor}`}
        >
          {icon}
        </motion.div>
        <p className="text-xs font-semibold uppercase text-gray-400 mb-1 tracking-widest">
          {label}
        </p>
        <motion.div
          className="text-3xl font-extrabold leading-tight text-gray-950"
